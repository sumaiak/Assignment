package lyngby.dk.HibernateConfiguration;


import jakarta.persistence.EntityManagerFactory;
import lombok.NoArgsConstructor;
import lyngby.dk.Exercise1.*;
...
public class HibernateConfig {
    ...
    private static EntityManagerFactory buildEntityFactoryConfig() {
        try {
            ...
            props.put("hibernate.connection.url", "jdbc:postgresql://localhost:5432/unicorn?currentSchema=public");
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        ...
        // configuration.addAnnotatedClass(<YOUR ENTITY>.class);ø
